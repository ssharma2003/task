...
<head>
    <title>Ph.D Medical Surgical Nursing | KMCH</title>
                ...
                <div class="col-sm-12">
                    <div class="tp-breadcrumb__content">
                     ...
                     <span class="white"><a href="index.html"><svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="tp-breadcrumb__title color">Research Programmes</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="tp-program-wrap wow fadeInUp" data-wow-delay=".3s">
                    <div class="tp-section text-center mb-55">
                        <h3 class="tp-section-title"><span> Research</span> Programmes</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="tp-program-item grey-bg mb-50">
                            <div class="tp-program-thumb fix">
                                <a href="{{route('academics.undergraduate.bsc-nursing')}}">
                                    <img src="/assets/img/program/phd_surgical_nursing.png" alt="program-thumb"></a>
                            </div>
                            <div class="tp-program-content">
                                <h3 class="tp-program-title"><a href="{{route('academics.undergraduate.bsc-nursing')}}">Ph.D Medical Surgical Nursing</a></h3>
                                <p>Doctoral program focusing on advanced research and expertise in medical-surgical nursing practices.</p>
                            </div>
                            <div class="tp-program-btn">
                                <a href="{{route('academics.research_programme.phd_medical_surging_nursing')}}">View detail</a>
                            </div> 
                        </div> 
                    </div>
                </div>
