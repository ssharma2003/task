                ...
                <div class="col-sm-12">
                    <div class="tp-breadcrumb__content">
                     ...
                     <span class="white"><a href="index.html"><svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="tp-breadcrumb__title color">Postgraduate Programmes</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="tp-program-item grey-bg mb-50">
                            <div class="tp-program-thumb fix">
                                <a href="{{route('academics.undergraduate.bsc-nursing')}}">
                                    <img src="/assets/img/program/msc_nursing.png" alt="program-thumb"></a>
                            </div>
                            <div class="tp-program-content">
                                <h3 class="tp-program-title"><a href="{{route('academics.undergraduate.bsc-nursing')}}">M.Sc. Nursing</a></h3>
                            ...
                            <div class="tp-program-btn">
                                <a href="{{route('academics.post_graduate.msc_nursing')}}">View detail</a>
                            </div> 
                        </div> 
                    </div>
                </div>
