                ...
                <div class="col-sm-12">
                    <div class="tp-breadcrumb__content">
                     ...
                     <span class="white"><a href="index.html"><svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="tp-breadcrumb__title color">Post basic diploma Programme</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="tp-program-wrap wow fadeInUp" data-wow-delay=".3s">
                    <div class="tp-section text-center mb-55">
                        <h3 class="tp-section-title"><span> Post basic diploma</span> Programmes</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="tp-program-item grey-bg mb-50">
                            <div class="tp-program-thumb fix">
                                <a href="{{route('academics.undergraduate.bsc-nursing')}}">
                                    <img src="/assets/img/program/critical_care_nursing" alt="program-thumb"></a>
                            </div>
                            <div class="tp-program-content">
                                <h3 class="tp-program-title"><a href="{{route('academics.undergraduate.bsc-nursing')}}">Critical Care Nursing</a></h3>
                                <p>Graduate program focusing on specialized areas of nursing practice, research, and leadership development.</p>
                            </div>
                            <div class="tp-program-btn">
                                <a href="{{route('academics.post_diploma.critical_care_nursing')}}">View detail</a>
                            </div>  
                        </div> 
                    </div>
                </div>
