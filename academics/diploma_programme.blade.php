                ...
                <div class="col-sm-12">
                    <div class="tp-breadcrumb__content">
                     ...
                     <span class="white"><a href="index.html"><svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="tp-breadcrumb__title color"> Diploma Programme</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="tp-program-wrap wow fadeInUp" data-wow-delay=".3s">
                    <div class="tp-section text-center mb-55">
                        <h3 class="tp-section-title"><span> Diploma</span> Programme</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="tp-program-item grey-bg mb-50">
                            <div class="tp-program-thumb fix">
                                <a href="{{route('academics.undergraduate.bsc-nursing')}}">
                                    <img src="/assets/img/program/diplomain_general_nursing" alt="program-thumb"></a>
                            </div>
                            <div class="tp-program-content">
                                <h3 class="tp-program-title"><a href="{{route('academics.undergraduate.bsc-nursing')}}">Diploma in General Nursing & Midwifery (DGNM)</a></h3>
                            ...
                            <div class="tp-program-btn">
                                <a href="{{route('academics.diploma_programme.diploma_in_general_nursing')}}">View detail</a>
                            </div>  
                        </div> 
                    </div>
                </div>
